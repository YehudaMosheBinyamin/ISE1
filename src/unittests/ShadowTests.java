...
public class ShadowTests {
    ...
    public void SphereTriangleInitial() {
        ...
        scene.addGeometries(new Sphere(new Color(java.awt.Color.BLUE), new Material(0.5, 0.5, 30), //
                ...
                new Triangle(new Material(0.5, 0.5, 30), new Point3D(-70, 40, 0), //
                        new Point3D(-40, 70, 0), new Point3D(-68, 68, 4), new Color(java.awt.Color.BLUE)));
    ...
    public void trianglesSphere() {
        ...
        scene.addGeometries( //
                new Triangle(new Material(0, 0.8, 60), new Point3D(-150, 150, 115), //
        ...
        scene.addLights(new SpotLight(new Color(700, 400, 400), //
                new Point3D(40, -40, -115),2E-5 , 1, 4E-4, new Vector(-1, 1, 4)));
