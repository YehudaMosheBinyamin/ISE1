...
public class RenderTests
{
    ...
    public void basicRenderMultiColorTest() {
        ...
        scene.addGeometries(new Sphere(new Color(123,23,55),new Material(0,0,0),50.0,
                new Point3D(0, 0, 100)));

        scene.addGeometries(
                new Triangle(
                        new Point3D(100, 0, 100), new Point3D(0, 100, 100),
    ...
    @Test
    public void basicAdaptiveRenderMultiColorTest() {
        Scene scene = new Scene("Test scene with adaptive supersampling");
        scene.setCamera(new Camera(Point3D.ZERO, new Vector(0, 0, 1), new Vector(0, -1, 0)));
        scene.setDistance(100);
        scene.setBackground(Color.BLACK);
        scene.setAmbientLight(new AmbientLight(new Color(java.awt.Color.WHITE), 0.2));

        scene.addGeometries(new Sphere(50.0, new Point3D(0, 0, 100)));
        ...
        new Triangle(
                new Point3D(-100, 0, 100), new Point3D(0, -100, 100),
                new Point3D(-100, -100, 100),new Color(java.awt.Color.ORANGE)); // upper left

        ImageWriter imageWriter = new ImageWriter("color render with adaptive supersampling", 500, 500, 500, 500);
