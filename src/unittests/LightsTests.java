...
public class LightsTests {
    ...
    public void trianglesDirectional() {
        ...
        scene.addGeometries(
                new Triangle(new Material(0.8, 0.2, 300), new Point3D(-150, 150, 150),
                        new Point3D(150, 150, 150), new Point3D(75, -75, 150), Color.BLACK),
                new Triangle(new Material(0.8, 0.2, 300), new Point3D(-150, 150, 150),
                        new Point3D(-70, -70, 50), new Point3D(75, -75, 150), Color.BLACK));
    ...
    public void trianglesPoint() {
        ...
        scene.addGeometries(
                new Triangle(new Material(0.5, 0.5, 300), new Point3D(-150, 150, 150),
                        new Point3D(150, 150, 150), new Point3D(75, -75, 150), Color.BLACK),
                new Triangle(new Material(0.5, 0.5, 300), new Point3D(-150, 150, 150),
                        new Point3D(-70, -70, 50), new Point3D(75, -75, 150), Color.BLACK));
    ...
    public void trianglesSpot() {
        ...
        scene.addGeometries(
                new Triangle(new Material(0.5, 0.5, 300),
